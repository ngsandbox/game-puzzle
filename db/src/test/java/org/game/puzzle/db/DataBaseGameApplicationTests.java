...
class DataBaseGameApplicationTests {
    ...
    void testSaveSpecies() {
        ...
        result = speciesService.getSpeciesById(humanId);
        Assertions.assertNotNull(result, "Species still exist with id: " + humanId);

        Assertions.assertThrows(NotFoundException.class,
                () -> speciesService.getSpeciesByLogin("victim1"),
                "Species still exist with login: victim1");
    }
